    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="rounded-2xl bg-gradient-to-br from-purple-900/50 to-pink-900/30 border border-purple-500/20 p-6">
        <div className="flex items-start gap-5">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-4xl flex-shrink-0">🤖</div>
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-1">
              <div className="text-2xl font-black text-white">訓練師 SA26010001</div>
              <span className="text-xs px-3 py-1 rounded-full bg-yellow-500/20 text-yellow-400 border border-yellow-500/20">🥚 孵化師認證</span>
            </div>
          ...
          <button className="text-xs px-3 py-1.5 rounded-lg bg-white/10 text-white/60 hover:text-white hover:bg-white/15 transition-all flex-shrink-0">編輯主頁</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-5">
        ...
        <div className="col-span-2 space-y-4">
          <div className="rounded-xl bg-white/[0.04] border border-white/10 p-5">
            ...
            <div className="space-y-3">
              {[
                { name: "小助理 Aria", lv: "Lv.3 訓練期", status: "服役中", statusColor: "text-green-400 bg-green-500/10", skills: ["🔍", "📚", "💬"], earnings: 0, listed: false },
                { name: "銷售小幫手 Max", lv: "Lv.2 成長期", status: "訓練中", statusColor: "text-yellow-400 bg-yellow-500/10", skills: ["👥", "📧", "🧠"], earnings: 0, listed: false },
              ].map((a) => (
                <div key={a.name} className="flex items-center gap-4 p-4 rounded-xl bg-white/[0.03] border border-white/5 hover:border-purple-500/20 transition-all">
                  ...
                  <div className="flex gap-2">
                    <Link href="/training" className="text-xs px-3 py-1.5 rounded-lg bg-white/5 text-white/50 hover:text-white hover:bg-white/10 transition-all">繼續訓練</Link>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl bg-white/[0.04] border border-white/10 p-5">
            ...
            <Link href="/cert" className="mt-3 block text-center text-xs text-purple-400 hover:text-purple-300">前往報考 →</Link>
          </div>
